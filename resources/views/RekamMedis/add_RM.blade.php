                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <textarea class="form-control f-md" name="terapi" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <textarea class="form-control f-md" name="pemeriksaan_penunjang" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <textarea class="form-control f-md" name="alergi_obat" required></textarea>
                                        </div>
                                    </div>
                                </div>
